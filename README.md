...
## 任意: 発信時に毎回確認 (通常電話 / 楽天リンク)

アプリ下部の「発信時に毎回確認」トグルを ON にすると、発信のたびに「楽天リンクで発信 / 通常の電話で発信」の選択オーバーレイが表示されます。

- **楽天リンクで発信**: 従来どおり転送されます
- **通常の電話で発信**: そのまま標準電話アプリで発信します (Shizuku 遮断中でも遮断は解除されません)
- **何も選ばない場合**: 4 秒後に通常の電話で発信します

> **注意**: システムの通話転送応答期限は端末により約 5 秒 (Samsung 固有、AOSP は約 10 秒) のため、選択時間は最大約 4 秒です。時間が足りない場合はトグルを OFF にしてください (従来どおり常に楽天リンクへ転送されます)。
